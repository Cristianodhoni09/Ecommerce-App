...
const UpdateProduct = () => {
  ...
  const params = useParams(); //To get the slug from url
        ...
        <div className="row">
          ...
          <div className="col-md-9">
            ...
            <div className="m-1 w-75">
                ...
                {/* Preview image either from URL(if photo is present, i.e., not changed) or from database */}
                <div className="mb-3">
                    {photo ? (
